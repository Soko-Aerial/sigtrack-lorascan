...
import com.sigtrack.lorascan.concurrent.CallbackContinuation
import com.sigtrack.lorascan.concurrent.Continuation
import com.sigtrack.lorascan.concurrent.SyncContinuation
import com.sigtrack.lorascan.android.bluetoothManager
import com.sigtrack.lorascan.util.exceptionReporter
...
class SafeBluetooth(private val context: Context, private val device: BluetoothDevice) :
    ...
    private class BluetoothContinuation(
        val tag: String,
        val completion: com.sigtrack.lorascan.concurrent.Continuation<*>,
