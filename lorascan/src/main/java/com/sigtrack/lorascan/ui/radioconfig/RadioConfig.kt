...
import com.sigtrack.lorascan.ui.radioconfig.components.EditDeviceProfileDialog
import com.sigtrack.lorascan.ui.radioconfig.components.PacketResponseStateDialog
...
fun RadioConfigScreen(
    ...
    var deviceProfile by remember { mutableStateOf<ClientOnlyProtos.DeviceProfile?>(null) }
