...
import com.sigtrack.lorascan.util.GPSFormat
import com.sigtrack.lorascan.util.latLongToMeter
...
data class Node(
    ...
    fun bearing(o: Node?): Int? = when {
        validPosition == null || o?.validPosition == null -> null
        else -> com.sigtrack.lorascan.util.bearing(latitude, longitude, o.latitude, o.longitude).toInt()
    }
